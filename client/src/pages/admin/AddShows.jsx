...
const AddShows = () => {
  ...
  const[dateTimeSelection,setDateTimeSelection]=useState(null);
      ...
      <div className='overflow-x-auto pb-4'>
        <div className='group flex flex-wrap gap-5 mt-4 w-max'>
          {nowPlayingMovies.map((movie) => (
            ...
            transition duration-300`} onClick={()=> setSelectedMovie(movie._id)}>
              ...
              {selectedMovie === movie._id && (
                ...
                bg-primary h-6 w-6 rounded-full'>
      ...
      <div className='mt-8'>
        ...
        <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
          ...
          <input type="number" min={0} value={showPrice} onChange={(e)=>
            setShowPrice(e.target.value)} className='bg-transparent border-none outline-none w-20'/>
        </div>
      </div>
      ...
      <div className='mt-8'>
        ...
        <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
          <input
            ...
            className='bg-transparent border-none outline-none w-44'
          />
